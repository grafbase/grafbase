...
impl ExecuteChangesOnDatabase for InsertNodeInternalInput {
    fn to_transaction<'a>(
        ...
        Box::pin(async {
            ...
            document.insert(OWNED_BY.to_string(), ctx.user_id.clone().into_attr());
    ...
    fn to_transaction<'a>(
        ...
        Box::pin(async move {
            ...
            let record = Record {
                ...
                owned_by: Option::<String>::from_attr(document.get(OWNED_BY).expect("must exist").clone())
                    .expect("Has to be valid"),
                document,
            };
