...
impl DynamicParse for BigIntScalar {
    fn parse(value: dynaql_value::ConstValue) -> crate::InputValueResult<serde_json::Value> {
        match value {
    ...
    fn is_valid(value: &dynaql_value::ConstValue) -> bool {
        match value {
    ...
    fn to_value(value: serde_json::Value) -> Result<dynaql_value::ConstValue, crate::Error> {
        match value {
