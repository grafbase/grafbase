...
use dynamodb::model::id::ID as IDModel;
...
fn node_create<'a>(
    ...
    let id = IDModel::new_owned(node_ty.name().to_string(), current_execution_id.to_string());
    ...
    async fn resolve(
        ...
        match self {
            ...
            DynamoMutationResolver::CreateNode { input, ty } => {
                ...
                let autogenerated_id = IDModel::new(&ty, &id);
