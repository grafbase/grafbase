...
pub struct MetaInputValue {
    ...
    pub default_value: Option<grafbase_engine_value::ConstValue>,
    #[serde(skip)]
...
impl Registry {
        ...
        if !possible_types.is_empty() {
            self.types.insert(
                ...
                UnionType {
                    ...
                    possible_types,
                    visible: None,
                    rust_typename: "grafbase_engine::federation::Entity".to_string(),
                    discriminators: None,
                }
                .into(),
            );
    ...
    pub(crate) fn create_federation_types(&mut self) {
        ...
        self.types.insert(
            "_Service".to_string(),
            ObjectType {
                rust_typename: "grafbase_engine::federation::Service".to_string(),
                ..ObjectType::new(
                    "_Service",
                    [MetaField {
                        name: "sdl".to_string(),
