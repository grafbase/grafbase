...
export const isLiveQuery = (definition?: DefinitionNode, variables?: { [key: string]: unknown }) =>
...
export class SSELink extends ApolloLink {
  ...
  public request(operation: Operation): Observable<FetchResult> {
    ...
    return new Observable((sink) => applyAsyncIterableIteratorToSink(client, sink))
  }
}
