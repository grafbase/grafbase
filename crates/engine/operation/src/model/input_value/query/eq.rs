...
pub fn is_query_value_equivalent_schema_value(
    ...
    match (left, right) {
        ...
        (QueryInputValueRecord::I64(l), SchemaInputValueRecord::I64(r)) => l == r,
        (QueryInputValueRecord::I64(_), _) => false,
...
pub fn are_query_value_equivalent(
    ...
    match (left, right) {
        ...
        (QueryInputValueRecord::Int(_), _) => false,
        (QueryInputValueRecord::I64(l), QueryInputValueRecord::I64(r)) => l == r,
        (QueryInputValueRecord::I64(_), _) => false,
