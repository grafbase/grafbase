...
impl std::fmt::Debug for ResolverDefinitionRecord {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ResolverDefinitionRecord::Extension(variant) => variant.fmt(f),
...
impl From<ExtensionResolverDefinitionRecord> for ResolverDefinitionRecord {
    fn from(value: ExtensionResolverDefinitionRecord) -> Self {
        ResolverDefinitionRecord::Extension(value)
    }
}
...
impl ResolverDefinitionRecord {
    pub fn is_extension(&self) -> bool {
        matches!(self, ResolverDefinitionRecord::Extension(_))
    }
    pub fn as_extension(&self) -> Option<ExtensionResolverDefinitionRecord> {
        match self {
            ResolverDefinitionRecord::Extension(item) => Some(*item),
            _ => None,
        }
    }
...
pub enum ResolverDefinitionVariant<'a> {
    Extension(ExtensionResolverDefinition<'a>),
...
impl std::fmt::Debug for ResolverDefinitionVariant<'_> {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ResolverDefinitionVariant::Extension(variant) => variant.fmt(f),
...
impl<'a> ResolverDefinition<'a> {
    ...
    pub fn variant(&self) -> ResolverDefinitionVariant<'a> {
        ...
        match self.as_ref() {
            ResolverDefinitionRecord::Extension(item) => ResolverDefinitionVariant::Extension(item.walk(schema)),
    ...
    pub fn is_extension(&self) -> bool {
        matches!(self.variant(), ResolverDefinitionVariant::Extension(_))
    }
    pub fn as_extension(&self) -> Option<ExtensionResolverDefinition<'a>> {
        match self.variant() {
            ResolverDefinitionVariant::Extension(item) => Some(item),
            _ => None,
        }
    }
    pub fn is_field_resolver_extension(&self) -> bool {
