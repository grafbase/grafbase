...
#[test]
fn worst_case_star_graph_greedy_trap() {
...
#[test]
fn worst_case_asymmetric_multi_level() {
...
#[test]
fn worst_case_high_cost_shared_edge() {
...
#[test]
fn worst_case_longer_cheaper_paths() {
    ...
    assert_eq!(
        total_weight,
        32,
        "Algorithm should find path with weight <= 32, got {}\n{}",
        total_weight,
        runner.debug_graph()
    );
}
...
#[test]
fn worst_case_equal_initial_costs_different_outcomes() {
    ...
    assert_eq!(
        total_weight,
        63,
        "Algorithm found solution with weight {}\n{}",
        total_weight,
        runner.debug_graph()
    );
}
...
#[test]
fn worst_case_cascading_suboptimal_choices() {
...
#[test]
fn worst_case_deceptive_density() {
...
#[test]
fn worst_case_zero_weight_edges_trap() {
...
#[test]
fn worst_case_terminal_ordering_sensitivity() {
...
#[test]
fn worst_case_large_approximation_ratio() {
...
#[test]
fn worst_case_bottleneck_graph() {
...
#[test]
fn worst_case_overlapping_paths_interdependencies() {
...
#[test]
fn worst_case_late_arriving_better_options() {
...
#[test]
fn worst_case_multiple_terminals_different_depths() {
...
#[test]
fn worst_case_flow_rate_confusion() {
...
#[test]
fn worst_case_parallel_asymmetric_branches() {
