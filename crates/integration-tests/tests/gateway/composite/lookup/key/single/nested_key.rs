...
fn no_arguments() {
    runtime().block_on(async {
        ...
        * At site Query.productLookup, for directive @lookup no matching @key directive was found
        43 | {
        44 |   productLookup: Product! @composite__lookup(graph: EXT) @extension__directive(graph: EXT, extension: ECHO, name: "echo", arguments: {}) @join__field(graph: EXT)
               ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
        45 |   products: [Product!]! @join__field(graph: GQL)
        "#);
    })
}
...
fn no_matching_argument() {
    runtime().block_on(async {
        ...
        * At site Query.productLookup, for directive @lookup no matching @key directive was found
        43 | {
        44 |   productLookup(somethign: Int): Product! @composite__lookup(graph: EXT) @extension__directive(graph: EXT, extension: ECHO, name: "echo", arguments: {}) @join__field(graph: EXT)
               ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
        45 |   products: [Product!]! @join__field(graph: GQL)
        "#);
    })
...
fn no_matching_nested_field() {
    runtime().block_on(async {
        ...
        * At site Query.productLookup, for directive @lookup no matching @key directive was found
        43 | {
        44 |   productLookup(nested: NestedInput!): Product! @composite__lookup(graph: EXT) @extension__directive(graph: EXT, extension: ECHO, name: "echo", arguments: {}) @join__field(graph: EXT)
               ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
        45 |   products: [Product!]! @join__field(graph: GQL)
        "#);
    })
...
fn arg_good_name_bad_type() {
    runtime().block_on(async {
        ...
        * At site Query.productLookup, for directive @lookup no matching @key directive was found
        43 | {
        44 |   productLookup(nested: Int): Product! @composite__lookup(graph: EXT) @extension__directive(graph: EXT, extension: ECHO, name: "echo", arguments: {}) @join__field(graph: EXT)
               ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
        45 |   products: [Product!]! @join__field(graph: GQL)
        "#);
    })
...
fn ambiguous_multiple_arg_matches() {
    runtime().block_on(async {
        ...
        * At site Query.productLookup, for directive @lookup no matching @key directive was found
        43 | {
        44 |   productLookup(a: NestedInput!, b: NestedInput!): Product! @composite__lookup(graph: EXT) @extension__directive(graph: EXT, extension: ECHO, name: "echo", arguments: {}) @join__field(graph: EXT)
               ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
        45 |   products: [Product!]! @join__field(graph: GQL)
        "#);
    })
...
fn ambiguous_multiple_field_matches() {
    runtime().block_on(async {
        ...
        * At site Query.productLookup, for directive @lookup no matching @key directive was found
        43 | {
        44 |   productLookup(a: NestedInput!): Product! @composite__lookup(graph: EXT) @extension__directive(graph: EXT, extension: ECHO, name: "echo", arguments: {}) @join__field(graph: EXT)
               ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
        45 |   products: [Product!]! @join__field(graph: GQL)
        "#);
    })
...
fn extra_required_argument() {
    runtime().block_on(async {
        ...
        * At site Query.productLookup, for directive @lookup no matching @key directive was found
        43 | {
        44 |   productLookup(nested: NestedInput!, required: Boolean!): Product! @composite__lookup(graph: EXT) @extension__directive(graph: EXT, extension: ECHO, name: "echo", arguments: {}) @join__field(graph: EXT)
               ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
        45 |   products: [Product!]! @join__field(graph: GQL)
        "#);
    })
