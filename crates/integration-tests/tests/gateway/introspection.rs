...
fn rejects_bogus_introspection_queries() {
    ...
    insta::assert_json_snapshot!(response, @r#"
    {
      "errors": [
        {
          "message": "__Type does not have a field named 'blarg'. It has the following fields: kind, name, description, inputFields, specifiedByURL, fields, enumValues, ofType, possibleTypes, interfaces",
          "locations": [
            {
              "line": 5,
              "column": 33
