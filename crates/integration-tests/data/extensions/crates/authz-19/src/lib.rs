use grafbase_sdk::{
    ...
    types::{
        AuthorizationDecisions, Configuration, Error, ErrorResponse, QueryElements, ResponseElements, SubgraphHeaders,
        Token,
    },
};
...
impl AuthorizationExtension for CustomAuthorization {
    ...
    fn authorize_query(
        ...
        let error_id = builder.push_error(Error::new("Not authorized, query auth SDK019"));
    ...
    fn authorize_response(
        ...
        let mut builder = AuthorizationDecisions::deny_some_builder();
        let error_id = builder.push_error(Error::new("Not authorized, response auth SDK019"));
