...
use crate::extension::{
    ...
    api::since_0_23_0::wit::{self, exports::grafbase::sdk::authorization::AuthorizationOutput},
};

impl AuthorizationExtensionInstance for super::ExtensionInstanceSince0_23_0 {
