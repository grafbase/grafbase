...
use since_0_14_0::ExtensionInstanceSince0_14_0;
pub use since_0_14_0::world as wit;
...
pub(crate) enum SdkPre {
    ...
    Since0_14_0(since_0_14_0::wit::SdkPre<WasiState>),
}
...
impl SdkPre {
    pub(crate) fn initialize(
        ...
        Ok(match sdk_version {
            ...
            _ => {
                since_0_14_0::Sdk::add_to_linker(&mut linker, |state| state)?;
                let instance_pre = linker.instantiate_pre(&component)?;
                SdkPre::Since0_14_0(since_0_14_0::SdkPre::<WasiState>::new(instance_pre)?)
            }
        })
    }
    ...
    pub(crate) async fn instantiate(
        ...
        match self {
            ...
            SdkPre::Since0_14_0(sdk_pre) => {
                let mut store = Store::new(sdk_pre.engine(), state);

                let inner = sdk_pre.instantiate_async(&mut store).await?;
                inner.call_register_extension(&mut store).await?;
                inner.call_init(&mut store, schema_directives, guest_config).await??;
