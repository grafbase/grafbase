...
use crate::wit::{self, since_0_8_0::resolver::FieldOutput};

pub struct ExtensionInstance {
    pub(super) store: Store<WasiState>,
    pub(super) inner: wit::since_0_8_0::Sdk,
...
impl ExtensionInstance {
    pub async fn resolve_field(
        ...
        inputs: InputList,
    ) -> crate::Result<wit::since_0_8_0::resolver::FieldOutput> {
        self.poisoned = true;

        let headers = self
            .store
            .data_mut()
            .push_resource(wit::since_0_8_0::headers::Headers::borrow(headers))?;
    ...
    pub async fn subscription_key(
        ...
        let headers = self
            .store
            .data_mut()
            .take_resource::<wit::since_0_8_0::headers::Headers>(headers_rep)?
            .into_owned()
            .unwrap();
    ...
    pub async fn authenticate(
        &mut self,
        headers: http::HeaderMap,
    ) -> crate::GatewayResult<(http::HeaderMap, wit::since_0_8_0::authentication::Token)> {
        self.poisoned = true;
    ...
    ) -> Result<wit::since_0_8_0::authorization::AuthorizationDecisions, crate::ErrorResponse> {
