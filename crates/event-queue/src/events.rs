...
/// Represents the type of GraphQL operation being executed.
...
pub enum OperationType {
    ...
    Mutation,
    /// A GraphQL subscription operation for real-time data
    Subscription,
}

impl From<grafbase_telemetry::graphql::OperationType> for OperationType {
    fn from(ty: grafbase_telemetry::graphql::OperationType) -> Self {
        match ty {
            grafbase_telemetry::graphql::OperationType::Query => OperationType::Query,
            grafbase_telemetry::graphql::OperationType::Mutation => OperationType::Mutation,
            grafbase_telemetry::graphql::OperationType::Subscription => OperationType::Subscription,
        }
    }
}
