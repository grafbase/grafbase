...
pub struct RunTool<R: engine::Runtime> {
    engine: EngineWatcher<R>,
}

impl<R: engine::Runtime> Tool for RunTool<R> {
...
impl<R: engine::Runtime> RunTool<R> {
    // FIXME: enforce enable_mutations
    pub fn new(engine: &EngineWatcher<R>, _enable_mutations: bool) -> Self {
