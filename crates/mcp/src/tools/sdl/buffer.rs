...
impl<'a> Buffer<'a> {
    ...
    pub fn write_object_definition(&mut self, object: ObjectDefinition<'_>, opt: &SdlOptions) {
    ...
    pub fn write_interface_definition(&mut self, interface: InterfaceDefinition<'_>, opt: &SdlOptions) {
    ...
    pub fn write_type_definition(&mut self, type_def: TypeDefinition<'_>, opt: &SdlOptions) {
        match type_def {
