	...
	<div class="relative">
		<div class="flex justify-between gap-4">
			...
			<button
					...
					on:click={deleteTodo}
			>
				<svg xmlns="http://www.w3.org/2000/svg" class={"h-5 w-5 hover:text-red-600 transition" + ( complete ? 'text-white': 'text-gray-600')} fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
