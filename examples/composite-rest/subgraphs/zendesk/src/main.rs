...
static DEALS: Lazy<HashMap<String, Deal>> = Lazy::new(|| {
    vec![
        Deal {
            id: "deal-1".to_string(),
...
static PRODUCTS: Lazy<HashMap<String, Product>> = Lazy::new(|| {
    vec![
        Product {
            id: "prod-1".to_string(),
...
static ORDERS: Lazy<HashMap<String, Order>> = Lazy::new(|| {
    vec![
        Order {
        ...
        Order {
            ...
            created_at: Utc::now() - chrono::Duration::days(24),
...
static LINE_ITEMS: Lazy<HashMap<String, Vec<LineItem>>> = Lazy::new(|| {
