...
export type GetAllPostsQuery = { __typename?: 'Query', postCollection?: { __typename?: 'PostConnection', edges?: Array<{ __typename?: 'PostEdge', node: { __typename?: 'Post', id: string, title: string, slug: string } } | null> | null } | null };
...
export type GetPostBySlugQuery = { __typename?: 'Query', post?: { __typename?: 'Post', id: string, title: string, slug: string } | null };
