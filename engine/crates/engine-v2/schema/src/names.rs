use crate::{
    Definition, EnumDefinitionId, EnumValueDefinitionId, FieldDefinitionId, InputObjectDefinitionId,
    InputValueDefinitionId, InterfaceDefinitionId, ObjectDefinitionId, ScalarDefinitionId, Schema, UnionDefinitionId,
};
...
pub trait Names: Send + Sync {
    ...
    fn enum_value<'s>(&self, schema: &'s Schema, enum_value_id: EnumValueDefinitionId) -> &'s str {
