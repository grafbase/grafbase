...
use crate::{
    ...
    plan::{
        error::PlanError, OperationSolutionContext, PlanResult, QueryPartition, QueryPartitionId,
...
use super::{
    ExecutableId, OperationPlan, OperationPlanContext, PlanId, PlanQueryPartition, PlanRecord, QueryModifications,
    ResponseModifierId, ResponseModifierRecord, ResponseModifierTargetRecord,
};

impl OperationPlan {
    #[allow(unused)]
    pub(in crate::plan) fn plan(
