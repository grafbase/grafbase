...
use super::{OldResponseObjectView, OldResponseObjectWithExtraFieldsWalker, ResponseValueWalker};
use crate::response::{ResponseListId, ResponseObjectId, ResponseValue};

impl<'a> serde::Serialize for super::OldResponseObjectsView<'a> {
...
impl<'a> serde::Serialize for super::OldResponseObjectsViewWithExtraFields<'a> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
...
impl<'a> serde::Serialize for OldResponseObjectWithExtraFieldsWalker<'a> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
...
impl<'a> serde::Serialize for OldResponseObjectView<'a> {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
