...
pub(crate) fn solve(schema: &Schema, bound_operation: BoundOperation) -> SolveResult<OperationSolution> {
    OperationSolution::solve(schema, bound_operation)
}

impl OperationSolution {
    fn solve(schema: &Schema, mut bound_operation: BoundOperation) -> SolveResult<Self> {
...
impl OperationSolutionBuilder<'_> {
    fn build(mut self) -> SolveResult<OperationSolution> {
        self.operation
