...
use crate::operation::{QueryOrSchemaInputValue, QueryOrSchemaInputValueView};

use super::{FieldArgumentId, HydratedOperationContext};

#[derive(Clone, Copy)]
pub struct HydratedFieldArguments<'a> {
    pub(in crate::operation::solve::model) ctx: HydratedOperationContext<'a>,
    pub(in crate::operation::solve::model) ids: IdRange<FieldArgumentId>,
}
