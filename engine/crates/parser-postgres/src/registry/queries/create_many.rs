...
pub(crate) fn register(
    ...
    let type_name = input_ctx.create_many_payload_name(table.client_name());
    ...
    meta_field.resolver =
        Resolver::PostgresResolver(PostgresResolver::new(Operation::CreateMany, input_ctx.directive_name()));
