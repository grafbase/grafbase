...
// I've no idea why we use 2 different error types for scalars.
//
// It seems silly, but it was not my decision, please do not sue
pub struct Error(pub String);

impl Error {
    pub fn new(err: impl Into<String>) -> Error {
        Self(err.into())
    }
}
