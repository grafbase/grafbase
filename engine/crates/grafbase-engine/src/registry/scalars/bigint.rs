...
impl DynamicParse for BigIntScalar {
    fn parse(value: grafbase_engine_value::ConstValue) -> crate::InputValueResult<serde_json::Value> {
        match value {
    ...
    fn is_valid(value: &grafbase_engine_value::ConstValue) -> bool {
        match value {
    ...
    fn to_value(value: serde_json::Value) -> Result<grafbase_engine_value::ConstValue, crate::Error> {
        match value {
