                ...
                pub unsafe fn _export_authorized_cabi<T: Guest>(
                    ...
                    match result5 {
                                ...
                                let base = result13.add(i * 20);
                                {
                                    match e {
                                        Some(e) => {
                                            ...
                                            *base.add(4).cast::<*mut u8>() = result11;
                                            let vec12 = (message7.into_bytes()).into_boxed_slice();
                        ...
                        Err(e) => {
                            ...
                            *ptr6.add(8).cast::<usize>() = len18;
                            *ptr6.add(4).cast::<*mut u8>() = result18;
                            let vec19 = (message14.into_bytes()).into_boxed_slice();
                            let ptr19 = vec19.as_ptr().cast::<u8>();
                            let len19 = vec19.len();
                            ::core::mem::forget(vec19);
                            *ptr6.add(16).cast::<usize>() = len19;
                            *ptr6.add(12).cast::<*mut u8>() = ptr19.cast_mut();
                        }
                    };
                    ptr6
                }
...
@\x03\x07context\x04\x04rules\x05input\x05\0\x08\x04\0\x0aauthorized\x01\x09\x04\
\x01\x20component:grafbase/authorization\x05\x06\x04\x01\x18component:grafbase/h\
