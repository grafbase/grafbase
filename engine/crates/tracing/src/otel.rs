...
impl TracingLayer {
    ...
    pub fn new_noop<S>() -> (ReloadableOtelLayer<S, Tracer>, ReloadableOtelLayerHandler<S, Tracer>)
    where
        S: Subscriber + for<'span> LookupSpan<'span>,
    {
