...
fn with_stdout_capture() {
    ...
    let wasi_module_path = concat!(
        ...
        "/../crates/integration-tests/data/extensions/crates/hooks-18/build"
    );
    ...
    runtime().block_on(async move {
        ...
        {"fields":{"extension":"hooks-18","message":"on-response-hook","guest_fields":{"operations":"0","subgraph_requests":"0","http_requests":"1","custom_events":"1","boolean":"false","optional_field":"foo","random_string":"random_string_value"}}}
        {"fields":{"extension":"hooks-18","message":"on-response-hook","guest_fields":{"operations":"1","subgraph_requests":"1","http_requests":"1","custom_events":"1","boolean":"false","optional_field":"foo","random_string":"random_string_value"}}}
        "#);
    });
}
