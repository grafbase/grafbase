...
impl CliError {
    ...
    pub fn to_hint(&self) -> Option<String> {
        match self {
            ...
            Self::BackendApiError(ApiError::CreateError(CreateError::Unknown)) |
            ...
            Self::BackendApiError(ApiError::NotLoggedIn) | Self::BackendApiError(ApiError::CorruptCredentialsFile) => Some("try running 'grafbase login'".to_owned()),
