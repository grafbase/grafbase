        ...
        match self {
            ...
            Self::BackendError(BackendError::DeleteDotGrafbaseDirectory(error)) => {
                match error.kind() {
                    ...
                    ErrorKind::PermissionDenied => Some("it apppears you do not have permissions to delete the .grafbase directory, try modifying the directory permissions".to_owned()),
                    _ => None,
                }
            }
            _ => None,
